    ...
    <div class="c-layout-page">
        ...
        <div class="c-layout-breadcrumbs-1 c-raindrops c-fonts-uppercase c-fonts-bold">
            <div class="container">
                <div class="c-page-title c-pull-left">
                    <h3 class="c-font-uppercase c-font-white c-font-sbold">{{ $category->title }}</h3>
        ...
        <div class="container">
            <div class="c-layout-sidebar-menu c-theme ">
                ...
                <ul class="c-sidebar-menu hidden-xs hidden-sm">
                    <li class="c-dropdown">
                ...
                <div class="c-bs-grid-small-space">
                    <div class="row">
                        @if(count($products)>0)
                            ...
                            @endforeach
                        @else
                            <div class="alert alert-info" role="alert">{{ trans('store::products.messages.products not found') }}</div>
                        @endif
                    </div>
                </div>
